const constants = {
    ...
    CONNECTIVITY_ERROR: "Some error occur while connecting the server kindly contact with admin",
    ...
    GET_ERROR: "Something wrong, refresh the page and remove browser cache or contact Admin",
